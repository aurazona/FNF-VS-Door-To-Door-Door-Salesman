...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bastard':
				frames = Paths.getSparrowAtlas('characters/scam_salesman');
				animation.addByPrefix('idle', 'scam idle', 24, false);
				animation.addByPrefix('singUP', 'scam up', 24, false);
			...
			case 'sticky':
				...
				animation.addByPrefix('idle', 'stickidle', 24, false);
				animation.addByPrefix('singUP', 'stickup', 24, false);
				animation.addByPrefix('singDOWN', 'stickdown', 24, false);
				animation.addByPrefix('singLEFT', 'stickleft', 24, false);
				animation.addByPrefix('singRIGHT', 'stickright', 24, false);
			...
			case 'bf-bastard':
				var tex = Paths.getSparrowAtlas('characters/bf-bastard');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
